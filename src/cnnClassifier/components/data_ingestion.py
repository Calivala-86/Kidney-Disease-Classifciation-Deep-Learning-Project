...
from src.cnnClassifier.utils.commom import get_size
from src.cnnClassifier.entity.config_entity import DataIngestionConfg
...
class DataIngestion:
    ...
    def download_file(self) -> str:
        ...
        try:
            ...
            logger.info(
                f"Downloaded data from {dataset_url} inot file {zip_download_dir}"
            )
